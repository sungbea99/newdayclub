...
import { UserTitlesBadges } from "@/components/user-titles";
        ...
        <div className="space-y-6">
          <Card>
            <CardContent className="p-6">
              ...
              {author?.userTitles && author.userTitles.length > 0 && (
                <div className="mt-3">
                  <UserTitlesBadges titles={author.userTitles} />
                </div>
              )}
              ...
              <div className="flex items-center justify-center gap-2 mt-4 pt-4 border-t">
                <div className="flex items-center gap-1 text-primary">
                  ...
                  <span className="font-medium text-sm">활동 {author?.activityCount || 0}회</span>
                </div>
              </div>
